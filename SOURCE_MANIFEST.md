...
| Sponsor implementation update in Codex task | `sources/sponsor-decisions/2026-08-23-account-registration-redesign-implementation.md` | Account naming and implemented pending-registration, OTP, activation, password, profile-phone, and cleanup behavior | Explicit sponsor-supplied implementation update, corroborated against the current `ark` working tree; requires publication reconciliation and re-assurance | 2026-08-23 | Present; checksum recorded below; supersedes earlier password-at-registration behavior but clears no production block |
| Sponsor implementation addendum in Codex task | `sources/sponsor-decisions/2026-08-23-account-otp-concurrency-hardening.md` | PostgreSQL-serialized OTP replacement, atomic attempt reservation, delivery-state ordering, invalidation enforcement, and fixed digest-length constraint | Explicit sponsor-supplied Account hardening update, corroborated against the current `ark` store, table metadata, migration, and tests; requires publication reconciliation and re-assurance | 2026-08-23 | Present; checksum recorded below; supplements the registration redesign source and clears no production block |
| Sponsor naming correction in Codex task | `sources/sponsor-decisions/2026-08-24-snake-case-database-identifiers.md` | Lowercase `snake_case` physical PostgreSQL schema-object identifiers instead of quoted PascalCase identifiers | Explicit sponsor correction; supersedes the active PascalCase rule and implementation ADR-0003; documentation reconciled while implementation migration remains pending | 2026-08-24 | Present; checksum recorded below; requires a coordinated schema/code migration and clears no production block |
...
4c3818fff1e4d67a7f08e50d6a521b5db89c88d8f2a39c14384aa4a6bef0a0ce  sources/sponsor-decisions/2026-08-23-account-registration-redesign-implementation.md
d1668ead51f40990990c2d48c044f0432b760247e99669284d55869b6f5ddeee  sources/sponsor-decisions/2026-08-23-account-otp-concurrency-hardening.md
4c5fb54e94e3e9fb17780647caebfe57eb814ca905d12cef0928bcd8d09e20cb  sources/sponsor-decisions/2026-08-24-snake-case-database-identifiers.md
...
The Stage 00 hashes pin the exact files discovered during the original audit. The 2026-08-15 sponsor-decision hashes pin the later decision sources interpreted by ADR-017 and ADR-018. The four 2026-08-18 sponsor-decision hashes pin the concrete identity-model revision, its Member uniqueness and one-current-API-key corrections, and the Organization-wide Member/Business/capability scope decision; all still require architecture reconciliation and an ADR. The two 2026-08-23 hashes pin the sponsor-supplied Account registration implementation update and its OTP concurrency/database-hardening addendum; their publication impact remains part of the pending identity reconciliation and Stage 24 re-assurance. The 2026-08-24 hash pins the sponsor correction that makes lowercase `snake_case` the target physical database-identifier convention; documentation is reconciled, while the implementation migration remains pending. The 2026-08-16 hashes pin the supplied ARK knowledge-system DOCX and its searchable normalization; they do not turn its examples into accepted decisions. A matching hash proves file identity, not provenance. Temporary-use approval is recorded in `decisions/ADR-000-temporary-source-evidence-disposition.md`.
